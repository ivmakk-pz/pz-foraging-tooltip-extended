...
- **Game context repo**: `C:\games\pz-modding-llm-context` — decompiled Java source, game Lua scripts, script definitions, release notes, modding docs. Read files from here to look up game APIs, method signatures, vanilla implementations, and script syntax.
- **Mod template**: `C:\games\pz-mod-template-ivmakk` ([GitHub](https://github.com/ivmakk/pz-mod-template-ivmakk)) — shared mod structure, changelog conventions, localization patterns, release workflow.
- **User's mods**: `C:\Users\ivmak\Zomboid\Workshop` — the user's own mods and mods from other authors being explored or collaborated on.
- **Steam Workshop mods**: `C:\Program Files (x86)\Steam\steamapps\workshop\content\108600\` — installed workshop mods by Steam ID.
