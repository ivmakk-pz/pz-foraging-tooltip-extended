...
├── {NEW_BUILD}/              # Development version (e.g., 42.13/)
...
1. Rename `42/` to the newer build folder (e.g., `42.13/`)
2. Copy it to the older build folder (e.g., `42.12/`)
3. Update newer `mod.info`: set `versionMin=42.13`, remove `versionMax`
...
- **Trailing `.0` on newer build's `versionMin`** — use `42.13` not `42.13.0`
